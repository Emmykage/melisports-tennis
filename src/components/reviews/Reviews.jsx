  ...
  return (
    <section className='px-4 py-20 bg-white my-10'>
        ...
        <div className='max-w-3xl py-10 m-auto gap-10 justify-center flex-col md:flex-row flex items-center'>
            ...
            <div className='flex flex-wrap flex-1 gap-3 items-center justify-center' > <FaStar className='text-primary' /><FaStar className='text-primary'/><FaStar className='text-primary'/><FaStar className='text-primary'/><FaStar className='text-primary'/> <p className='text-lg font-medium'> help improve our site</p></div>
            ...
            <div className='my-10'>
                ...
                value={review.content}
                 className='w-full h-60 p-6 border border-theme rounded'></textarea>
            </div>
