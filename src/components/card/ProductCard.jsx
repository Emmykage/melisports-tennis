...
const ProductCard = ({product}) => {
  return (
    <div key={product.id} className="text-center md:basis-[24%] basis-[48%] border border-theme-dark p-3 mb-6 rounded-xl h-max bg-white overflow-hidden sm:min-w-48 w-full ">
            <div className="m-0">
