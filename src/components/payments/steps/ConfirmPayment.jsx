...
const ConfirmPayment = ({
  ...
  const cpayment =
    billingDetails.payment_method === "on_delivery" ? "Pay Later" : "Paystack";
  ...
  return (
    <div className="rounded-lg">
      ...
      <div className="max-w- mx-auto mt-10 p-6 bg-white rounded-2xl shadow-md border border-gray-200">
        <h4 className="text-xl font-normal text-gray-800 mb-4">
        ...
        <div className="space-y-3 text-sm text-gray-700 ">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-gray-600 text-right">
              {billingDetails?.street} {billingDetails?.city}{" "}
      ...
      <div className="flex justify-between gap-6">
        ...
        {billingDetails.payment_method === "on_delivery" ? (
          ...
          <PaystackButton
            className="font-semibold flex-1 block text-center py-3 px-3 border-2 border-dark"
            {...componentProps}
          />
        )}
      </div>
