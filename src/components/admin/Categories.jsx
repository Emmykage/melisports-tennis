  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 hover:border-gray-900 overflow-y-auto">
      <div className="mt-4 flow-root">
        ...
        <thead>
          <tr>
            <th scope="col" class="sticky top-0 z-10 border-b border-gray-200/50 bg-white bg-opacity-75 py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-gray-600 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">categories</th>
            <th scope="col" class="sticky top-0 z-10 border-b border-gray-200/50 bg-white bg-opacity-75 py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-gray-600 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">description</th>
            <th scope="col" class="sticky top-0 z-10 border-b border-gray-200/50 bg-white bg-opacity-75 py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-gray-600 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8" />
            <th scope="col" class="sticky top-0 z-10 border-b border-gray-200/50 bg-white bg-opacity-75 py-3.5 pl-4 pr-3 text-left text-xs font-semibold text-gray-600 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8" />
