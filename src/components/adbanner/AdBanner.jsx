...
const AdBanner = () => {
  ...
  return (
    <section>
      <div className="md:max-w-[1400px] w-full my-10 md:h-[800px] m-auto flex   flex-col  lg:flex-row gap-4 px-4 lg:px-0 lg:py-0">
        <div className="md:w-96 sm:h-full h-40 group bg-gray-200 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
          <Swiper
            loop
            effect="cube"
            centeredSlides
          ...
          >
            <SwiperSlide>
              <img
                ...
                className="w-full h-full object-cover sm:object-fill md:object-fill cursor-pointer group-hover:scale-105 transition duration-500"
        ...
        <div className="flex flex-1 flex-col gap-4">
          <div className="md:flex-1 group h-40 sm:h-96 bg-gray-200 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition duration-300">
            <img
              src={banner1}
              alt="add banner"
