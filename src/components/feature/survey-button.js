...
const SurveyButton = () => (
  ...
  <section id="survey" className="px-4 my-4">
    <div className="py-20 m-auto max-w-4xl text-center">
      ...
      <a href="https://docs.google.com/forms/d/e/1FAIpQLScUbwSfyzAwo5o1QNjkmOJgc_ILcoIFzvglgLUmZg7n2r4xfA/viewform?pli=1" target="_blank" className="bg-primary text-white py-3 px-8 rounded-lg hover:bg-primary/80" rel="noreferrer">Survey</a>
