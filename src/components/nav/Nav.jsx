...
const Nav = ({
  ...
  const storeItems = [
    ...
    },
    {
      ...
      sub: [
        {
          link: "/court-directory",
          label: "Court Directory",
        },
        { link: "/community", label: "CD Programs" },
        {
          link: "/contact",
          label: "Contact Us",
        },
            ...
            {sub && (
              <div className="absolute left-0 group-hover:flex hidden">
                {label === "Racquets" ? (
                  ...
                  <div className="mt-8 bg-white flex flex-col w-80 gap-3 px-6 py-4 shadow-xl rounded-xl">
                    {sub.map((subItem) => (
                      <NavLink
                        to={`${subItem.link}`}
      ...
      <nav className="fixed left-0 right-0 transition-all duration-300 w-full h-auto bg-gray-200 top-0 z-50 shadow-md">
        {!stickyNav && (
          <div className="py-2  px-4  bg-gray-100">
            <div className="flex m-auto justify-between max-w-7xl">
              ...
              <span className="text-xs">Help & Service</span>
            </div>
          </div>
        )}
        <div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-5">
            <a
              href="#survey"
              className="bg-gray-60 py-1 rounded px-3  lg:text-dark  hidden md:block"
            >
              {" "}
              Survey
            </a>
            ...
            {store
              ? storeItems.map((item) => (
                  ...
                  >
                    ...
                    {item.sub && (
                      <div
                        className={`mt-2 pl-4 border-l overflow-hidden transform transition-all duration-75 ease-linear ${openDropdown ? "h-auto" : "h-0"} `}
                      >
