...
export const DistributorBanner = () => (
  ...
  //     <h1 className="ml fc-white text-center text-6xl"></h1>
  //     <p className="ml text-lg text-gray-300 font-medium text-center">  .</p>
  //   </div>
  // </div>
  ...
  >
    ...
    <div className="relative z-10 max-w-3xl text-center text-white p-8 bg-white/10 backdrop-blur-md rounded-2xl shadow-lg animate-fadeIn">
      <h1 className="text-4xl md:text-6xl font-bold mb-4">Become A Distributor</h1>
      <p className="text-base text-white md:text-lg leading-relaxed">
        Welcome to
        {' '}
        <span className="font-semibold text-primary -300">Melisports</span>
        ,
