...
// handleSearch
  (
    <form className="max-w-md w-full ml-auto" onSubmit={(e) => e.preventDefault()}>
      <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only">Search</label>
      <div className="relative">
        <input value={search} onChange={handleSearch} name="search" placeholder="Seacrh Product..." type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900  rounded-lg bg-gray-50 focus:ring-blue-500 focus:outline-non focus:border-gray-300 " required />
