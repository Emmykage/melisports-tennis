  ...
  return (
    <form onSubmit={handleSUbmit} className="flex-1">
      <div>
        ...
        <div>
          {' '}
          <label htmlFor="phone_no">Phone Numbe</label>
          {' '}
          <input required type="text" className="py-2 border w-full rounded" value={billingDetails.phoneNumber} name="phone" onChange={handleChange} />
        </div>
