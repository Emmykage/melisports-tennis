...
import { FaFacebook, FaLocationDot, FaPhone, FaTwitter } from "react-icons/fa6";
    ...
    <div className='max-w-5xl m-auto mt-10 px-4'>
        ...
        <div className='flex justify-between my-4'>
            <div className='border p-3 rounded'>
                ...
                <p> {invoice?.order_detail?.billing_address?.state}</p>
            </div>
            <div className=''>
                <p> <span className='font-semibold'> Invoice No: </span> {invoice?.invoice_number}</p>
                <p> <span className='font-semibold'> Date Issued:  </span> {localDateString(invoice?.created_at)}</p>
            </div>
        </div>
        ...
        <table>
         ...
         <div>
                ...
                <div className=''>
                    <div className='flex justify-between gap-4'><span className='font-semibold'> SUB TOTAL</span> <span>{nairaFormat(invoice?.sub_total_amount)}</span> </div>
                    <div className='flex justify-between gap-4'><span className='font-semibold'> VAT</span> <span>{nairaFormat(invoice?.vat)}</span> </div>
                    <div className='flex justify-between'><span className='font-semibold'> TOTAL</span> <span>{nairaFormat(invoice?.total_amount)}</span> </div>
                </div>
                ...
                <div className='flex justify-between mt-4'>
                    <div>
                        <div className='flex gap-4 items-center'>
                           <span><FaLocationDot className='text-primary'/></span> <span className='font-medium text-gray-600'> 1 Kandi Close, Wuse 2 Abuja, Nigeria</span>
                    </div>
                     <div className='flex gap-4 items-center'>
                           <span><FaPhone className='text-primary'/></span> <span className='font-medium text-gray-600'> +2348123111983 </span>
                           <span><MdOutlineMailOutline className='text-primary'/></span> <span className='font-medium text-gray-600'> melisports1@gmail.com </span>
                           <span><TiWorldOutline className='text-primary'/></span> <span className='font-medium text-gray-600'> www.melisports.com </span>
                    </div>

                    <div className='flex gap-4 items-center'>
                        <FaFacebook className='text-primary'/><span>melisports</span><FaTwitter className='text-primary'/> <span>melisports</span> <FaInstagramSquare className='text-primary'/> <span> melisports1@gmail.com</span>
