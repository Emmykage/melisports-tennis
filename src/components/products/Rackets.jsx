    ...
    <div className='flex-2 bg- relative overflow-hidden pb-4'>
      <div className='px-2 block'>
        <div>
          ...
          <p className='px-1 text-sm text-white' >{racquet.technical_characteristics.description}</p>
            ...
            <h2 className='color-white font-normal'> TECHNICAL CHARACTERISTICS </h2>
              ...
              <li className=' border-t p-05 m-02'>
                ...
                <div className='flex flex-between'>
                  ...
                  <span className='text-sm'>  {racquet.technical_characteristics.tension}</span>
                </div>
              </li><li className=' border-t m-02 p-05'>
                <div className='flex flex-between'>
          ...
          <tbody>
             {racquet.variations.map(variation => (
                <tr>
                    ...
                    <td>{variation.head_size? variation.size : "N/A"}</td>
      ...
      <div className='whatsapp'>
        <a aria-label="Chat on WhatsApp" target='_blank' href={`https://wa.me/+2347038723093?text=I'm%20interested%20in%20the%20${racquet.name}%20racquet`}> <img alt="Chat on WhatsApp" src={whatsap} /></a>
