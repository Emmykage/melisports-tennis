  ...
  return (
    <Container>
      ...
      {latestArrival.length > 0 && (
        <section className="px-3  py-20">
          <h3 className="text-2xl text-center">
            {" "}
            <NavLink className="hover:text-primary" to="/arrivals">
              {" "}
              New Arrival
            </NavLink>
          </h3>
          <div className="m-auto max-w-7xl my-6 bg-white p-4 md:p-10 border rounded shadow-sm">
            {latestArrival.length > 0 ? (
              ...
              <span className="text-xl block font-medium text-center">
                {" "}
                New Arrivals will be updated Soon
              </span>
            )}
          </div>
        </section>
      ...
      <div className="my-6 bg-white py-10">
        <h3 className=" text-center font-medium  text-3xl my-3">
          {" "}
          Shop Categories
        </h3>
