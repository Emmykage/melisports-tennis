...
const Arrivals = () => {
  ...
  const { products, latestArrival, status, error } = useSelector(
    (state) => state.products,
  );
  const { product_categories, loading } = useSelector(
  ...
  return (
    <Container>
      <Hero image={bannerImage} title="Latest Arrivals" />
      ...
      <div className="prod-page">
        <div className="cat-group justify-between max-w-md my-6">
          ...
          <a className="btn" onClick={() => dispatch(getProducts())}>
            All Rackets
          </a>
        </div>
        ...
        <div className="flex md:gap-10">
          <SideNav className="side-nav bg-white shadow md:w-72 rounded-xl border border-theme-dark/50">
            <div className="side-row py-2 px-10 border-b border-theme-dark/50">
              <h6 className="text-base text-theme-dark font-medium">
                Activities
              </h6>
            </div>
            <div />
            ...
            <div className="side-row">
              ...
              <span className="items-center flex mb-2">
                <input
                  ...
                  id="junior"
                  value="junior"
                  className="mr-3 w-4 h-4 text-blue-600 bg-gray-100 border-gray-100 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  onChange={handleFilteredActivities}
                />
          ...
          {loading ? (
            ...
            <div className="product-align w-full">
              <ProductsGrid products={latestArrival} error={error} />
