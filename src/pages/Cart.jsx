          ...
          <div className="cart-div  my-4 px-4 gap-4 bg-white flex justify-between m-auto max-w-[1500px] min-h-[70%]">
            <div className="overflow-x-scroll flex-1 cart-inner-div">
              ...
              <table className="hidden md:table md:border-separate md:border-spacing-y-4 w-full">
                <caption className="py-6 text-lg text-left px-4 font-semibold text-gray-600">
                ...
                <thead>
                  <tr>
                    ...
                    <th className=" hidden lg:table-cell sticky top-0  z-10 border-gray-200/50  bg-opacity-75 px-3 py-3.5 pr-3 text-right font-semibold  backdrop-blur backdrop-filter">
                      Price
                    </th>
                    <th className="hidden lg:table-cell sticky top-0  z-10 border-gray-200/50  bg-opacity-75 px-3 py-3.5 pr-3 text-right font-semibold  backdrop-blur backdrop-filter">
                      {" "}
                ...
                <tbody className="">
                  {cartItems?.map((cart) => (
                    <tr
                      key={cart.product_name}
                      className="grid grid-cols-1 w-full items-center md:table-row lg:grid-cols-0"
                    >
                      <td
                        data-cell="image"
                        className="flex w-full md:w-36 md:table-cell whitespace-nowrap  mb-4 overflow-hidden bg-gray-100  py-3 text-sm text-gray-600/90 font-normal"
                      >
                        <div className="cart-img m-auto shrink-1 p-4 flex  ">
                          <img
                            src={cart?.image}
                            className="w-36 h-36 shrink-0 object-fill "
                          />
                        </div>
                      </td>
                      <td
                        data-cell="name"
                        className="md:table-cell whitespace-nowrap  bg-gray-100  pl-3 py-3 text-sm text-gray-900 font-medium"
                      >
                        <p className="text-gray-700 font-semibold">
                          {cart?.product_name}
                        </p>
                        <p className="text-gray-700 text-sm font-semibold">
                          <span className="mr-3 font-semibold text-xs text-gray-500">
                            Colour:{" "}
                          </span>
                        ...
                        <p>
                          <span className="mr-3 font-semibold text-gray-500 text-xs">
                            Size:{" "}
                          </span>
                          {cart?.size}
                        </p>
                      ...
                      <td
                        data-cell="price"
                        className="md:table-cell whitespace-nowrap text-right bg-gray-100 px-3 py-3 "
                      >
                        {(cart?.discount || cart?.discount_amount) && (
                          <p className="text-sm text-gray-700 font-normal line-through">
                            {nairaFormat(
                              cart?.discount ?? cart?.discount_amount,
                            )}
                          </p>
                      ...
                      <td
                        data-cell="quantity"
                        className=" md:table-cell whitespace-nowrap bg-gray-100  px-3 py-3 text-sm text-gray-600/90 font-normal text-right"
                      >
            ...
            <div className="cart-side md:w-72 shrink-0  py-4 px-2 border rounded-lg">
              <div className="flex justify-between items-center">
                <h2 className="mb-4 font-light">Order Summary</h2>
              </div>
