    ...
    <Container>
      <div className="section-container h-fit">
        ...
        <div className="grid grid-cols-3 gap-y-5">
          {brandItems.map((item) => (
            <div className="box-shadow text-center h-72 my-2">
              <img src={item.logo} alt={item.name} className="w-full h-full" />
            </div>
          ))}
          <div className="box-shadow text-center h-72 my-2">
            <img src={babolat} alt="" className="w-full h-full" />
          </div>
          <div className="box-shadow text-center h-72 bg-white my-2">
            <img src={NTF} alt="ntf logo" className="w-full h-full" />
          </div>
          <div className="box-shadow text-center h-72 bg-white my-2">
            <img src={MeliJouer} alt="" className="w-full h-full" />
          </div>
        </div>
      </div>
    </Container>
