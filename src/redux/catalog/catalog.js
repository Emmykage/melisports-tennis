...
const initialState = {
  ...
  {
    name: 'Voltage',
    image: 'https://fglprdcdn.azureedge.net/images/873952-100-1-Large.jpg',
    type: 'racquet',
  ...
  {
    name: 'Junior 21 Wimbledon Strung',
    image: 'https://media.babolat.com/image/upload/f_auto,q_auto,c_pad,w_1008,h_1008/v1617537317/Product_Media/2022/Tennis_Rackets/WIMBLEDON_RACKETS/140448-Junior_21_Wim-100-1-Face.png',
    type: 'racquet',
    description: 'The Junior 21 Wimbledon racquet is suitable for young beginners between 105 and 120 cm tall. Designed in the image of the legendary British Grand Slam.',
    technical_characteristics: {
  ...
  {
    name: 'Junior 25 Wimbledon Strung',
